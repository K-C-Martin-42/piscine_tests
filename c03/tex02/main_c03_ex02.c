...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/28 10:33:55 by kmartin           #+#    #+#             */
/*   Updated: 2022/11/28 10:33:57 by kmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	run_test(char *src, int d_num_char, int d_len);
...
void	run_test(char *src, int d_num_char, int d_len)
{
	...
	print_str("\n\nORIGINAL FUNCTION: ");
	strcat(dest_orig, src);
	print_str_n_X(dest_orig, d_len);

	print_str("\n\nTEST FUNCTION:     ");
	ft_strcat(dest_test, src);
