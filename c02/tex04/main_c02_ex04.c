...
/*   Updated: 2022/11/17 16:20:02 by kmartin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	char	low_string[100] = "abcdefghijklmnopqrstuvwxyz";
	char	space_string[100] = "lowercase words with spaces";
	char	mix_string[100] = "AStringwithMixedcasewords";
	char	zero_string[100] = "";

	print_string(low_string);
	run_test(low_string);
...
void	run_test(char *str)
{
	...
	if (result == 0)
		write(1, "\nString contains non-lowercase alphabetical characters.\n", 56);
	else
		write(1, "\nString contains no non-lowercase alphabetical characters.\n", 59);
